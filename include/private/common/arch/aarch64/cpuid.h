...
#ifndef PRIVATE_ARCH_AARCH64_CPUID_H_
#define PRIVATE_ARCH_AARCH64_CPUID_H_
...
#define DEFAULT_CPU_NAME            "Generic AArch64 processor"
...
namespace lsp
{
    ...
    static uint32_t read_hwcap()
    {
        ...
        if (hwcap & HWCAP_AARCH64_FP)
            res        |= CPU_HWCAP0_FP;
        if (hwcap & HWCAP_AARCH64_ASIMD)
            res        |= CPU_HWCAP0_ASIMD;
    ...
    static uint32_t read_hwcap()
    {
        ...
        {
            if (val != 0)
                hwcap          |= CPU_HWCAP0_FP | CPU_HWCAP0_ASIMD;
        }
...
#endif /* PRIVATE_ARCH_AARCH64_CPUID_H_ */
