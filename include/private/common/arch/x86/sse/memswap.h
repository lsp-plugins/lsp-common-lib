...
#ifndef PRIVATE_ARCH_X86_SSE_MEMSWAP_H_
#define PRIVATE_ARCH_X86_SSE_MEMSWAP_H_

#ifndef PRIVATE_COMMON_ARCH_X86_SSE_IMPL
    #error "This header should not be included directly"
#endif /* PRIVATE_COMMON_ARCH_X86_SSE_IMPL */
    ...
    namespace sse
    {
        void memswap(void *a, void *b, size_t count)
        {
            ...
            (
                ...
                __ASM_EMIT("movups      0x20(%[a]), %%xmm2")
                __ASM_EMIT("movups      0x30(%[a]), %%xmm3")
                __ASM_EMIT("movups      0x00(%[b]), %%xmm4")
                __ASM_EMIT("movups      0x10(%[b]), %%xmm5")
                __ASM_EMIT("movups      0x20(%[b]), %%xmm6")
                __ASM_EMIT("movups      0x30(%[b]), %%xmm7")
                __ASM_EMIT("movups      %%xmm4, 0x00(%[a])")
                __ASM_EMIT("movups      %%xmm5, 0x10(%[a])")
                __ASM_EMIT("movups      %%xmm6, 0x20(%[a])")
                __ASM_EMIT("movups      %%xmm7, 0x30(%[a])")
                __ASM_EMIT("movups      %%xmm0, 0x00(%[b])")
                __ASM_EMIT("movups      %%xmm1, 0x10(%[b])")
                __ASM_EMIT("movups      %%xmm2, 0x20(%[b])")
                __ASM_EMIT("movups      %%xmm3, 0x30(%[b])")
                ...
                __ASM_EMIT("jl          8f")
                __ASM_EMIT("movlps      0x00(%[a]), %%xmm0")
                __ASM_EMIT("movlps      0x00(%[b]), %%xmm4")
                __ASM_EMIT("movlps      %%xmm4, 0x00(%[a])")
                __ASM_EMIT("movlps      %%xmm0, 0x00(%[b])")
                ...
                __ASM_EMIT("movss       0x00(%[b]), %%xmm4")
                __ASM_EMIT("movss       %%xmm4, 0x00(%[a])")
                __ASM_EMIT("movss       %%xmm0, 0x00(%[b])")
...
#endif /* PRIVATE_ARCH_X86_SSE_MEMSWAP_H_ */
