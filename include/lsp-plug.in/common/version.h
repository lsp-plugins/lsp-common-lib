...
#elif defined(LSP_DEBUG) || defined(LSP_IDE_DEBUG)
    #define LSP_COMMON_LIB_EXPORT
    #define LSP_COMMON_LIB_CEXPORT
    #define LSP_COMMON_LIB_IMPORT
    #define LSP_COMMON_LIB_CIMPORT
#elif defined(LSP_COMMON_LIB_BUILTIN)
    #define LSP_COMMON_LIB_EXPORT       LSP_SYMBOL_HIDDEN
    #define LSP_COMMON_LIB_CEXPORT      LSP_SYMBOL_HIDDEN
    #define LSP_COMMON_LIB_IMPORT       LSP_SYMBOL_HIDDEN
    #define LSP_COMMON_LIB_CIMPORT      LSP_SYMBOL_HIDDEN
#else
    #define LSP_COMMON_LIB_EXPORT
    #define LSP_COMMON_LIB_CEXPORT
