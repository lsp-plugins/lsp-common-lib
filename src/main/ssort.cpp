...
namespace lsp
{
    ...
    static size_t symmerge_binary_search(
        ...
        size_t szof, sort_compar_t compar, void *arg)
    {
        size_t low          = 0;
    ...
    static void symmerge(uint8_t *first, uint8_t *mid, uint8_t *last, size_t szof, sort_compar_t compar, void *arg)
    {
    ...
    static void insertion_sort(uint8_t *head, size_t count, size_t szof, sort_compar_t compar, void *arg)
    {
