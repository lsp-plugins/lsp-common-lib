...
#include <lsp-plug.in/stdlib/string.h>
    ...
    #define PRIVATE_COMMON_ARCH_ARM_IMPL
        #include <private/common/arch/arm/memswap.h>
    #undef PRIVATE_COMMON_ARCH_ARM_IMPL

    #define EXPORT2(function, export) \
    { \
        lsp::function                       = arm::export; \
