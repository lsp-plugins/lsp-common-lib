...
#include <lsp-plug.in/stdlib/string.h>
    ...
    #define PRIVATE_COMMON_ARCH_ARM_NEON_D32_IMPL
        #include <private/common/arch/arm/neon-d32/memswap.h>
    #undef PRIVATE_COMMON_ARCH_ARM_NEON_D32_IMPL
