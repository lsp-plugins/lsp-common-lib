...
#include <lsp-plug.in/stdlib/string.h>
    ...
    #define PRIVATE_COMMON_ARCH_AARCH64_IMPL
        #include <private/common/arch/aarch64/memswap.h>
    #undef PRIVATE_COMMON_ARCH_AARCH64_IMPL

    #define EXPORT2(function, export) \
    { \
        lsp::function                       = aarch64::export; \
