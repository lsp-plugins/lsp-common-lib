...
#include <lsp-plug.in/stdlib/string.h>
    ...
    #define PRIVATE_COMMON_ARCH_AARCH64_ASIMD_IMPL
        #include <private/common/arch/aarch64/asimd/memswap.h>
    #undef PRIVATE_COMMON_ARCH_AARCH64_ASIMD_IMPL
